local PartPool = {}
local TexturePool = script:FindFirstChild("TexturePool") or Instance.new("Folder")
TexturePool.Name = "TexturePool"
TexturePool.Parent = script
...
function poolService.FlushPools()
